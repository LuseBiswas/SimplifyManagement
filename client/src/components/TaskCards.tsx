...
function TaskCards() {
    ...
    function handleHover(e: React.DragEvent<HTMLDivElement>){
        ...
        return (
            ...
            <Paper sx={{height:"80vh", width:"auto" , overflow:"auto", padding:"0px 0px", backgroundColor:"#212529"}} elevation={10} onDragOver={handleHover} onDrop={handleTodo}>
                <Typography variant="h5" component="div" style={{ textAlign: "center", padding:"10px", backgroundColor:"#cbf3f0"}}>
                    To-Do
                </Typography>
            ...
            <Grid item sm={12} md={3} lg={3}>
            <Paper sx={{height:"80vh", width:"auto" , overflow:"auto", padding:"0px 0px", backgroundColor:"#212529"}} elevation={10} onDrop={handleDrop} onDragOver={handleHover}>
                <Typography variant="h5" component="div" style={{ textAlign: "center", padding:"10px", backgroundColor:"#fcf6bd" }}>
                    Doing
                </Typography>
                <Grid container spacing={2} marginTop={1} sx={{display:"flex", justifyItems:'center', justifyContent:'center'}}>
                {pending.map(task => {
            ...
            <Grid item sm={12} md={3} lg={3}>
            <Paper sx={{height:"80vh", width:"auto" , overflow:"auto", padding:"0px 0px", backgroundColor:"#212529"}} elevation={10} onDragOver={handleHover} onDrop={handleNotPending} >
                <Typography variant="h5" component="div" style={{ textAlign: "center", padding:"10px", backgroundColor:"#d0f4de" }}>
                    Done
                </Typography>
                <Grid container spacing={2} marginTop={1} sx={{display:"flex", justifyItems:'center', justifyContent:'center'}}>
                {tasks.map(task => {
